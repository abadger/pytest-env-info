# -*- coding: utf-8 -*-
#
# pytest-env-info documentation build configuration file, created by
...
project = u'pytest-env-info'
copyright = u'2017, Toshio Kuratomi'
author = u'Toshio Kuratomi'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-env-info Documentation',
     [author], 1)
]
